...
4. [Tools for Debugging](#tools-for-debugging)
5. [Best Practices for Debugging](#best-practices-for-debugging)
...
The most basic tool is the browser's developer tools. All modern web browsers have built-in developer tools that allow you to inspect the HTML, CSS, and JavaScript of a web page, as well as to run JavaScript code in the browser's console. For example, the following code shows how to use the Chrome DevTools to debug a simple web page that calculates and displays the average of two numbers:
...
<html>
  ...
  <body>
    ...
    <p>
      The average of <span id="x">3</span> and <span id="y">4</span> is
      <span id="z">3.5</span>.
    </p>
...
To use the developer tools, you first need to open the web page in the browser and then open the developer tools by pressing `F12` on the keyboard, or by clicking on the "Tools" menu and selecting "Developer Tools".
...
We hope this blog post has given you some useful tips and tricks for debugging JavaScript, and that you will continue to practice and improve your debugging skills.
