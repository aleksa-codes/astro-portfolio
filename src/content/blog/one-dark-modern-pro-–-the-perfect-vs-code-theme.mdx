...
description: Upgrade your VS Code experience with One Dark Modern Pro, a sleek
  ...
  Code’s Dark Modern UI. Perfect for developers who want a polished and
  distraction-free workspace.
date: 2025-02-06
author: aleksa-codes
thumbnail: /public/images/theme_banner.png
tags:
  - Development
  - Best Practices
---
As a web developer, I’ve spent a lot of time searching for the perfect dark theme for my editor. I’ve been using Atom’s iconic **One Dark Pro** theme, specifically its darker variant, for quite a while. It’s one of the most installed themes for VS Code, and I love its syntax highlighting. However, even the darker variant didn’t quite hit the mark for me. I also really liked the clean look of the native **Dark Modern** theme in VS Code, but I missed the syntax colors from One Dark Pro. So, I made my own theme.
...
![Image of code example using One Dark Modern Pro VS code theme](/public/images/code-example.png)
