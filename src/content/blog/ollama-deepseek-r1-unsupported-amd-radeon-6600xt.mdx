...
thumbnail: '/public/images/deepseek-chat.png'
tags:
  - AI
  - LLM
  - Ollama
...
2. Copy the command from the top right of the page:
   ```
   ollama run deepseek-r1:1.5b
   ```
3. Open a terminal (Windows PowerShell or Command Prompt) and paste the command:
   ```
   ollama run deepseek-r1:1.5b
   ```
4. This will download and install the model. Once complete, the chat interface will start.

![DeepSeek R1 running in Windows Terminal](/public/images/ollama-deepseek-terminal.png)

5. To exit the chat, type:
   ```
   /bye
   ```
