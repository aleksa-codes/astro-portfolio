...
4.  **iHateCJ:** A dynamic landing page for a Kick streamer, using the Kick API to display real-time stream data. Assets and branding were creatively enhanced with AI image generation.
    -   **Tech:** Astro, Kick API, Real-Time Data, ChatGPT
    -   **Demo:** [ihatecj.netlify.app](https://ihatecj.netlify.app/)
5.  **Next Workout:** Modern fitness app with AI-generated workout plans and built-in timers. Features customizable parameters, circuit/straight set options, and embedded video demonstrations for effective home workouts.
...
6.  **GPT Image Captioner:** Advanced tool for generating detailed image descriptions. Optimized for LoRA model training with support for batch processing and customizable outputs.
...
7.  **Easy WebsiteGPT:** Innovative Chrome extension for interactive conversations with any webpage. Features real-time streaming responses and persistent chat history.
...
8. **GPT FileSmith:** Creative content generator inspired by Rick and Morty's multiverse concept. Creates unique, imaginative content with instant preview and download options.
...
9. **Flux Ghibsky Illustration:** Popular Flux AI LoRA model for generating Ghibli-inspired landscapes and scenes. Garnering over 30,000 monthly generations across Hugging Face and Replicate.
...
10. **Easy Website Blocker:** Powerful productivity extension for eliminating digital distractions. Features customizable block lists and granular exceptions for focused work sessions.
...
11. **One Dark Modern Pro:** Sleek and modern VS Code theme inspired by Atom's One Dark Pro. Features vibrant syntax highlighting and modern UI design.
...
12. **Next Meal:** Intuitive recipe discovery app with instant meal suggestions and video tutorials. Perfect for when you need quick meal ideas.
