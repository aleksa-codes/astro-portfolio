...
export function getRSS(posts: (MarkdownInstance | MDXComponent)[]): any {
  return {
    ...
    title: 'Blog Posts (from scarlettdanger.studio)',
    description:
      'Beginner friendly developer and information security content, with a focus on React, TypeScript, Next.js, Astro, Tailwind CSS and more.',
